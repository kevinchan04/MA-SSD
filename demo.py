...
@torch.no_grad()
def run_demo(cfg, ckpt, score_threshold, images_dir, output_dir, dataset_type, is_save):
    if dataset_type == "voc":
    ...
    for i, image_path in enumerate(image_paths):
        ...
        FPS_list.append(round(1.0 / inference_time))
    ...
    print("avg FPS for all images: ", avg_FPS)
